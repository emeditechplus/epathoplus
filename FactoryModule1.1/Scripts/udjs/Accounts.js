...
$(document).ready(function () {
    ...
    $('#ddlAccTypeDr').change(function () {
        ...
        setTimeout(function () {
            ...
            if ($('#hdnmtclaim').val() == 'Y') {
                $("#ddlDepartmentDr").val('A424305F-8D71-4440-9AE2-D491E254F4F0');  /*SALES-MT*/
                $("#ddlBusinessSegDr").val('0AA9353F-D350-4380-BC84-6ED5D0031E24'); /*MODERN TRADE*/

                $("#ddlDepartmentCr").prop("disabled", true);
                $("#ddlBusinessSegCr").prop("disabled", true);
            }
            else {
    ...
    $('#ddlAcctypeCr').change(function () {
        ...
        if ($('#hdnmtclaim').val() == 'Y') {
            $("#ddlDepartmentCr").val('A424305F-8D71-4440-9AE2-D491E254F4F0');  /*SALES-MT*/
            $("#ddlBusinessSegCr").val('0AA9353F-D350-4380-BC84-6ED5D0031E24'); /*MODERN TRADE*/
    ...
    function chktdsdel(accdrvalue) {
        ...
        $("#creditadd tbody tr").each(function () {
            ...
            if (accledgerid == accdrvalue) {
                ...
                $("#txtcredittotalamount").val(totalcredit.toFixed(2));
    ...
    $("body").on("click", "#creditadd .Creditdel", function () {
        ...
        if (confirm("Do you want to delete this Account?")) {
            ...
            //    }
            //})
            if (tdsapplicable == 'false' || tdsapplicable == 'N') {
       ...
       // $('#myModaltds').css("display", "");
        ...
        $('#tdslist tbody tr').each(function () {
            ...
            if (chk == '1') {
                ...
                $("#txtcredittotalamount").val(totalcreditt.toFixed(2));
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if ($('#hdnmtclaim').val() == 'Y') {
                ...
                //BindAccountTypedr_MTClaim(vc, region);    /* Dr. Side not bind issue */
...
function Debitadd(AccountID, AccountName, DebitAmount, DeductableAmount, DeductablePercent, DeductableLedgerID, IsCostCenter, IsTagInvoice, Isautoposting, NonTaxableAmount, ByDefaultAmount, TransactionAmount, remarks, departmentid, departmentname, taxapplicable, BusinessSegId, BusinessSegName) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $("#txtdebittotalamount").val(totaldebit.toFixed(2));
            $("#hdn_totaldr").val(totaldebit);
            $("#debitadd").append(tableNew);
    ...
    $.ajax({
        ...
        success: function (Accresponse) {
            ...
            if (messagetext != '0') {
                ...
                toastr.error('<b><font color=black> Data cannot be saved as session is lost' + messagetext + '</font></b>');
            }
        },
...
function Cal_GST_Tax(taxable) {
    ...
    if (taxable != '' && taxablevalue != '') {
        ...
        $("#txtDCJ_TaxAmount").val(_totaltaxamt.toFixed(2));
